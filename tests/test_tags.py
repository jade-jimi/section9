...
class TestTagOnCreate(unittest.TestCase):
    ...
    def test_g4_auto_card_gets_tags(self):
    ...
    def test_g5_human_tags_respected(self):
        rid = self.cli("new", "request", "--title", "터미널 스피너 정리",
