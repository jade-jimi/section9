...
class TestClaimCli(unittest.TestCase):
    ...
    def test_l6_add_normalizes_id(self):
    ...
    def test_l7_claim_appends_transcript(self):
    ...
    def test_l8_leaving_prunes_short_id(self):
    ...
    def test_l9_claimed_short_id_blocks_respawn(self):
...
class TestSpawnPidRecord(unittest.TestCase):
    ...
    def test_l10_mark_pid_preserves_marker(self):
    ...
    def test_l11_mark_pid_tolerates_mock(self):
        class P:
            pid = object()
    ...
    def test_l12_all_spawn_sites_record_pid(self):
