...
class TestTddProgress(unittest.TestCase):
    ...
    def test_t1_v_label_generations_merge(self):
        body = "\n".join([
            "- [x] V1. 구세대 문구 A",
            "- [x] V2. 구세대 문구 B",
            "- [ ] V3. 구세대 문구 C",
