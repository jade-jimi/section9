...
class PasteFoldCore(unittest.TestCase):
    ...
    def test_s1_multiline_folds(self):
        r = self.run_js("""
    ...
    def test_s3_short_paste_not_folded(self):
        r = self.run_js("""
          console.log(JSON.stringify({
    ...
    def test_s4_single_long_line(self):
        r = self.run_js("""
    ...
    def test_s2_expand_restores_original(self):
        r = self.run_js("""
          const orig = "가\\n나\\n다\\n라\\n마\\n바";
    ...
    def test_s7_edited_chip_is_literal(self):
        r = self.run_js("""
          const orig = "비밀\\n원문\\n1\\n2\\n3\\n4";
          const e = {n:1, label: pasteFoldLabel(1, orig), text: orig};
    ...
    def test_s8_no_nested_reexpansion(self):
        r = self.run_js("""
          const inner = "안쪽\\n1\\n2\\n3\\n4\\n5";
    ...
    def test_label_prefix_safety(self):
        r = self.run_js("""
...
class SourceContract(unittest.TestCase):
    ...
    def test_store_outlives_shell(self):
    ...
    def test_regressions_intact(self):
        for probe, why in [
    ...
    def test_hint_updated_everywhere(self):
