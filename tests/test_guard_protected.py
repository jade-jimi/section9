...
class GuardProtected(unittest.TestCase):
    ...
    def test_g1_executable_text_is_protected(self):
    ...
    # G2. 데이터는 종전처럼 보호 밖
    def test_g2_data_paths_stay_open(self):
    ...
    def test_g3_role_line_change_is_detected(self):
    ...
    def test_g4_token_patterns_are_caught(self):
    ...
    def test_g5_codeowners_lists_the_paths(self):
