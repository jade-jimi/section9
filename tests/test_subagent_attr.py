...
class TestAttribution(unittest.TestCase):
    ...
    def test_c4_mentioned_open_doc(self):
        calls = run_hook({"session_id": "s1", "agent_type": "designer",
    ...
    def test_c5_mentioned_done_doc_rejected(self):
        calls = run_hook({"session_id": "s1", "agent_type": "designer",
                          "last_assistant_message":
    ...
    def test_c6_other_session_doc_rejected(self):
        calls = run_hook({"session_id": "s1", "agent_type": "designer",
    ...
    def test_c7_own_session_doc_accepted(self):
