...
class ActorSpecTest(unittest.TestCase):
    ...
    def test_a1_spec_forms_pass_through(self):
    ...
    def test_a2_legacy_is_read_leniently(self):
    ...
    def test_a3_boundaries_never_raise(self):
    ...
    def test_a3_kind_extraction(self):
...
class ContribAccumTest(unittest.TestCase):
    ...
    def test_a4_one_note_one_entry(self):
        meta = {}
    ...
    def test_a5_same_actor_and_item_merges(self):
        meta = {}
    ...
    def test_a5_different_item_appends(self):
        meta = {}
        s9.record_contribution(meta, "sub:designer:aaaa1111", item="N1",
                               ts="2026-08-25T21:00:00+09:00")
    ...
    def test_a6_item_defaults_to_first_line(self):
    ...
    def test_a7_open_running_entry_is_closed(self):
        """열린 running 항목은 같은 actor의 다음 보고가 닫는다 — 항목이 영원히
        '진행 중'으로 남아 헬스체크를 오염시키는 것을 막는다."""
        meta = {}
