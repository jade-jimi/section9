...
class RequestOrigin(unittest.TestCase):
    ...
    # O1. 사람 입구
    def test_o1_human_entrance(self):
    ...
    # O2. 에이전트 파생
    def test_o2_agent_derived_from_parent(self):
    ...
    # O4. 에이전트 자발 + --agent
    def test_o4_agent_spontaneous(self):
    ...
    # O5. 옛 문서
    def test_o5_legacy_read_rules(self):
    ...
    # O7·O8. 카탈로그·왕복
    def test_o7_o8_catalog_and_roundtrip(self):
        parent, _ = self.new("--origin", "human", "--user", "alice")
        rid, meta = self.new("--parent", parent, "--user", "alice",
                             env={"S9_SESSION": "leadsess"})
