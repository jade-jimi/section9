...
class CompactSignal(unittest.TestCase):
    ...
    # N1. 방금 시작했으면 압축 중이다
    def test_n1_fresh_is_compacting(self):
        self.assertTrue(self.m.chat_compacting({"compacting": _ago(5)}))

    # N2. 끝 훅이 비우면 아니다
    def test_n2_cleared(self):
    ...
    def test_n4_served_on_chat_target(self):
