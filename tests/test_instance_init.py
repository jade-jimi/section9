...
class TestInstanceInit(unittest.TestCase):
    ...
    def test_i4_hook_cwd_detection(self):
    ...
    def test_i5_no_detection_outside_root(self):
    ...
    def test_i6_upgrade_merge(self):
